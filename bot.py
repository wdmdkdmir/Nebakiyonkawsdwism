...
async def start(event):
  await event.reply("**LoungeTagger Bot**, Grup veya kanaldaki neredeyse tüm üyelerden bahsedebilirim ★\nDaha fazla bilgi için **/help**'i tıklayın.",
                    buttons=(
                      ...
                      Button.url('📣 Support', 'https://t.me/FsmTeamSupportChat'),
                      Button.url('🚀 Sahibim', 'https://t.me/IAMMEMOOK')]
                    ),
                    link_preview=False
                   )
...
print(">> Bot çalıyor merak etme 🚀 @FsmTeamSupportChat bilgi alabilirsin <<")
